...
#include <localization/my_service.h>
// OpenCV
...
class MyServer
{
  private:
    ...
    bool serviceCb(localization::my_service::Request &req, 
                   localization::my_service::Response &res){
  ...
  public:
    MyServer(): it_(nh_){
      ...
      package_path_ = ros::package::getPath("localization");
